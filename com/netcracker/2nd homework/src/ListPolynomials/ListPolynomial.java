...
public class ListPolynomial {
    ...
    /**
     *  Adds a new term into the ListPolynomial, assuming that the ListPolynomial
     ...
     *  The method does not change the original ListPolynomial.
     */
    public ListPolynomial add(ListPolynomial poly)
    {
        ListPolynomial res = clone();
    ...
    public ListPolynomial clone()
    {
        ListPolynomial res = new ListPolynomial();
    ...
    public boolean equals(ListPolynomial poly)
    {
        Monomial tmp1 = head;
     ...
     *  The method does not change the original ListPolynomial.
     */
    public ListPolynomial multiply(double num) {
        ListPolynomial res = clone();
    ...
    /**
     *  Returns a new ListPolynomial that is the derivative of this ListPolynomial.
     */
    public ListPolynomial diff() {
        ListPolynomial res = new ListPolynomial();
    ...
    /**
     *  Computes the ListPolynomial at x = value
     */
    ...
    /*public static void main(String[] args) {
        ListPolynomial first = new ListPolynomial();
        ListPolynomial second = new ListPolynomial();
        ...
        ListPolynomial third = first.add(second);
        ...
        ListPolynomial fourth = first.multiply(0.2);
        System.out.println( fourth );
        System.out.println( first );
        System.out.println( );

        System.out.println( "differentiate first" );
        ListPolynomial diff = first.diff();
